...
public class SampleGattAttributes {
	...
	// "0000C004-0000-1000-8000-00805f9b34fb";
	
	
	public static String HEART_RATE_MEASUREMENT = "0000FFF4-0000-1000-8000-00805f9b34fb";
	public static String CLIENT_CHARACTERISTIC_CONFIG = "00002902-0000-1000-8000-00805f9b34fb";
	public static String HUAWEI_T8951_UUID = "0000110a-0000-1000-8000-00805f9b34fb";
	public static String SENSOR_DATA_GATHER_PLATFORM_SERVICE_UUID = "180F";
	public static String SENSOR_DATA_GATHER_PLATFORM_CHARACTERISTIC_UUID = "";
